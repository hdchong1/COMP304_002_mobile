    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nurseViewModel.getInsertResult().observe(this, new Observer<Integer>() {
            ...
            public void onChanged(@Nullable Integer result) {
                if (result ==1) {
                    Toast.makeText(Main2Activity.this,"Nurse successfully saved", Toast.LENGTH_SHORT).show();
                }else {
                    Toast.makeText(Main2Activity.this,"Error saving nurse", Toast.LENGTH_SHORT).show();
                }
            }
        });
